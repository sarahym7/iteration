...
GOAL: Go over to amazon and get customer reviews of napolean dynamite and gather it as data. Ie. reading data from the 
web using rvest 
...
we don't want to copy and past and repeat everything twice. It will be annoying. So we will do something different. 
Lets turn this code into  a function. The only input we have that changes is the pages,so whats the structure? Here its just the URL.
...
- setting stage for next vids 
- lets suppose we have the dynamite URL base. Will be everything upto the page we are insterested in.
 - combine the url base with the numbers 1-5 
...
Have functiona and pass into vector 
Have function that can pass into a function 
